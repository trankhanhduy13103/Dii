        ...
        <div className="row">
          ...
          <main className="col-md-6">
            <article className="product-info-aside">
              ...
              {/* price-detail-wrap .// */}
              <p>
              Tại Mỹ, chúng ta nghe nói rằng kết cục của hơn một nửa các cuộc hôn nhân là ly hôn. 
              Ở Bồ Đào Nha, con số này là 70%. Với các cuộc hôn nhân thứ hai ở Mỹ, tỷ lệ ly hôn tăng lên 65%, và đối với các cuộc hôn nhân thứ ba,
              tỷ lệ này lên đến 75%. Ở Việt Nam, cứ 4 cặp vợ chồng đăng ký kết hôn thì có 1 đôi ly hôn sau đó.
              Một trong những nguyên nhân dẫn đến những con số choáng ngợp ấy là hai người chưa biết cách “giao tiếp” trong tình yêu hay nói đúng hơn 
              là học cách thể hiện đúng tình yêu của chính mình và cách đón nhận đối phương{" "}
              </p>
              <dl className="row">
