...
function Lightnovell() {
  ...
  <section className="padding-bottom">
    <header className="section-heading heading-line">
      <h4 className="title-section text-uppercase">Xe Côn Tay</h4>
    </header>
    <div className="card card-home-category">
      <div className="row no-gutters">
        <div className="col-md-3">
          <div className="home-category-banner bg-light-orange">
            <h5 className="title">Dòng xe mạnh nhanh</h5>
            <p>
            Dòng xe phù hợp với lứa tuổi con báo thích đua xe bốc đầu.{" "}
            </p>
            <a href="/category1" className="btn btn-outline-primary rounded-pill">
              Xem Ngay
            </a>
